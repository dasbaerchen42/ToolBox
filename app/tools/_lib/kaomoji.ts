...
export const KAOMOJI_GROUPS: KaomojiGroup[] = [
  ...
  group("greet", "打招呼", [
    ["(・∀・)ノ", "揮手 你好 hi"], ["ヾ(＾∇＾)", "揮手 你好 hi"],
    ["( ´ ▽ ` )ﾉ", "揮手 你好 hi"], ["(*・ω・)ﾉ", "揮手 你好 hi"],
    ["ﾉ(・ω・´)", "揮手 再見 bye"], ["(´･ω･)ﾉ", "揮手 bye"],
    ["(o´ω`o)ﾉ", "打招呼 hi"], ["( ﾟ▽ﾟ)/", "揮手 hi"],
  ]),
  group("celebrate", "慶祝與感謝", [
    ["\\(^o^)/", "萬歲 慶祝 歡呼"], ["ヽ(∀ﾟ )人( ﾟ∀)ノ", "擊掌 慶祝"],
    ["(*´∀`)~♥", "感謝 開心"], ["(´∀`)b", "讚 good"],
    ["ｷﾀ━━━(ﾟ∀ﾟ)━━━!!", "來了 興奮 慶祝"],
    ["m(_ _)m", "鞠躬 感謝 抱歉 thanks"], ["(*- -)(*_ _)", "鞠躬 感謝 thanks"],
    ["✧*。٩(ˊᗜˋ*)و✧*。", "慶祝 加油 開心"],
  ]),
  group("think", "思考與平靜", [
    ["(¬_¬)", "無言 懷疑"], ["(￣ー￣)", "得意 平靜"],
